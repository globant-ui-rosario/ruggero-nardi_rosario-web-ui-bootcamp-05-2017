      ...
      <nav className="navbar navbar-inverse text-center">
        <div className="container-fluid">
          <div className="navbar-header">
            ...
            <NavLink className="navbar-brand visible-xs" to={'/Home'}>World Of Warcraft STATS</NavLink>
          </div>
          <div className="collapse navbar-collapse" id="myNavbar">
            <ul className="nav navbar-nav">
              ...
              <li className="dropdown">
                <a className="dropdown-toggle a-nav-link nav-button" data-toggle="dropdown" >LEADERBOARDS
